...
export default function LiquidMetalHero({
    ...
    return (
        <section className="relative min-h-[500px] h-full flex items-center justify-center overflow-hidden rounded-xl bg-gray-900 text-white isolate">
            ...
            <div className="container mx-auto px-6 lg:px-8 max-w-7xl relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <motion.p
                            className="max-w-2xl mx-auto text-lg sm:text-xl text-foreground/90 leading-relaxed"
                            variants={itemVariants}
                        >
                            {subtitle}
                        </motion.p>
