...
export function HeroSection() {
    return (
        <div className="dark w-full bg-neutral-950 text-foreground selection:bg-primary/20">
            <HeroHeader />
            <main className="overflow-x-hidden">
                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-48">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl font-bold tracking-tight text-white">Build 10x Faster with NS</h1>
                ...
                <section className="bg-neutral-950 pb-2 text-white">
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            ...
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                ...
                                <div className="bg-gradient-to-r from-neutral-950 absolute inset-y-0 left-0 w-20"></div>
                                <div className="bg-gradient-to-l from-neutral-950 absolute inset-y-0 right-0 w-20"></div>
                                <ProgressiveBlur
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto max-w-7xl rounded-3xl px-6 transition-all duration-300 lg:px-12', scrolled && 'bg-neutral-950/50 backdrop-blur-2xl border border-white/10')}>
                    <motion.div
                        key={1}
                        ...
                        <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
                            ...
                            <div className="hidden lg:block">
                                <ul className="flex gap-8 text-sm text-white/90">
