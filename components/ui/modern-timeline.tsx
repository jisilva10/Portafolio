...
export function Timeline({ items, className, scrollContainerRef }: TimelineProps) {
                    ...
                    {items.map((item, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                viewport={{ root: scrollContainerRef, once: true, margin: "-30px" }}
                                role="listitem"
                                        ...
                                        <Card className={cn(
                                            ...
                                            <CardContent className="p-4 sm:p-6">
                                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4 mb-3">
                                                    ...
                                                    >
                                                        {item.status ? (item.status === 'completed' ? 'Completado' : item.status === 'current' ? 'Actual' : 'Futuro') : "Futuro"}
                                                    </Badge>
                                                </div>
